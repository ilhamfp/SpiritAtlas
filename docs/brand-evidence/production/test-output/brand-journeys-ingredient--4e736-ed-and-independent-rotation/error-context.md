...
- Location: tests/brand-journeys.spec.ts:177:1
...
- generic [ref=f5e3]:
  - link "Skip to content" [ref=f5e4] [cursor=pointer]:
    - /url: "#landing-content"
  - banner [ref=f5e5]:
    - link "SpiritAtlas home" [ref=f5e6] [cursor=pointer]:
      - /url: /
      - text: SpiritAtlas.
    - navigation "Main navigation" [ref=f5e7]:
      - link "The bars" [ref=f5e8] [cursor=pointer]:
        - /url: "#the-bars"
      - link "Inside the drink" [ref=f5e9] [cursor=pointer]:
        - /url: "#inside"
      - link "Open atlas" [ref=f5e10] [cursor=pointer]:
        - /url: /?bar=bar-bon-funk
  - main [ref=f5e14]:
    - region [ref=f5e15]:
      - generic:
        - heading "Singapore’s cocktails. Inside out." [level=1] [ref=f5e16]: Singapore’scocktails.Inside out.
        - paragraph [ref=f5e17]: Explore the bars. Unfold the ingredients. Discover a different side of every drink.
        - link "Explore the atlas" [ref=f5e18] [cursor=pointer]:
          - /url: /?bar=bar-bon-funk
      - generic [ref=f5e22]:
        - generic [ref=f5e23]: 1.2922° N / 103.8393° E
        - group "BBF Negroni interactive 3D viewer" [ref=f5e25]:
          - generic [aria-hidden]:
            - button:
              - generic: "1"
              - text: Orange garnish
          ...
          - generic [ref=f5e29]:
            - button "Zoom in" [ref=f5e30] [cursor=pointer]
            - button "Zoom out" [ref=f5e32] [cursor=pointer]
        - generic [ref=f5e34]:
          - generic [ref=f5e35]:
            - generic [ref=f5e36]: 01 / BAR BON FUNK
            - link "BBF Negroni" [ref=f5e37] [cursor=pointer]:
              - /url: /?drink=bbf-negroni
          - button "Look inside" [ref=f5e41] [cursor=pointer]
        - generic [ref=f5e45]:
          - generic [ref=f5e46]: Drag to discover another angle
          - generic [ref=f5e47]:
            - button "Rotate featured cocktail left" [ref=f5e48] [cursor=pointer]
            - button "Rotate featured cocktail right" [ref=f5e51] [cursor=pointer]
      - generic [ref=f5e54]:
        - generic [ref=f5e55]: SINGAPORE, THROUGH A DIFFERENT GLASS
        - link "Meet the three bars" [ref=f5e56] [cursor=pointer]:
          - /url: "#the-bars"
    - region [ref=f5e59]:
      - generic [ref=f5e60]:
        - heading "Three bars. Distinctly their own." [level=2] [ref=f5e61]: Three bars.Distinctly their own.
        - paragraph [ref=f5e62]: One city. Three interpretations of the Negroni.Start with a familiar drink. See where it takes you.
      - generic [ref=f5e63]:
        - article [ref=f5e64]:
          - 'link "Explore Bar Bon Funk: BBF Negroni" [ref=f5e65] [cursor=pointer]':
            - /url: /?drink=bbf-negroni
            - generic [ref=f5e66]:
              - generic [ref=f5e67]: "01"
              - generic [ref=f5e68]: River Valley
            - img "Deep red to brown-red liquid. Straight rocks glass with substantial clear base. Large clear ice and rounded orange garnish" [ref=f5e73]
            - heading "Bar Bon Funk" [level=3] [ref=f5e74]
            - generic [ref=f5e75]: BBF Negroni
          - paragraph [ref=f5e76]: Time, cold and orange aroma. An oak-aged take at New Bahru.
          - link "Explore the drink" [ref=f5e77] [cursor=pointer]:
            - /url: /?drink=bbf-negroni
        - article [ref=f5e80]:
          - 'link "Explore MOGA: Ichigo Negroni" [ref=f5e81] [cursor=pointer]':
            - /url: /?drink=ichigo-negroni
            - generic [ref=f5e82]:
              - generic [ref=f5e83]: "02"
              - generic [ref=f5e84]: City Hall
            - img "Transparent golden-amber liquid. Cylindrical rocks glass and large clear ice. Densely petalled yellow flower over a round red garnish" [ref=f5e89]
            - heading "MOGA" [level=3] [ref=f5e90]
            - generic [ref=f5e91]: Ichigo Negroni
          - paragraph [ref=f5e92]: Strawberry meets milk clarification in the Ichigo Negroni.
          - link "Explore the drink" [ref=f5e93] [cursor=pointer]:
            - /url: /?drink=ichigo-negroni
        - article [ref=f5e96]:
          - 'link "Explore Bar Somma: Negroni Express" [ref=f5e97] [cursor=pointer]':
            - /url: /?drink=negroni-express
            - generic [ref=f5e98]:
              - generic [ref=f5e99]: "03"
              - generic [ref=f5e100]: River Valley
            - img "Red-orange liquid in a low tumbler with curved lower profile. Prominent clear ice block. Curved wrinkled green shishito with its stem" [ref=f5e105]
            - heading "Bar Somma" [level=3] [ref=f5e106]
            - generic [ref=f5e107]: Negroni Express
          - paragraph [ref=f5e108]: A red-orange Negroni with a distinctive pickled shishito garnish.
          - link "Explore the drink" [ref=f5e109] [cursor=pointer]:
            - /url: /?drink=negroni-express
    - region [ref=f5e112]:
      - generic [ref=f5e113]:
        - heading "There’s more in the glass." [level=2] [ref=f5e114]: There’s morein the glass.
        - paragraph [ref=f5e115]: A garnish. A spirit. An unexpected detail.Open up a cocktail and explore the ingredients that make it its own.
        - link "Explore ingredients" [ref=f5e116] [cursor=pointer]:
          - /url: /?drink=ichigo-negroni&expand=1
        - generic [ref=f5e120]: Ingredients shown separately to help you explore.Estimates are marked; shapes don’t indicate amounts.
      - generic [ref=f5e121]:
        - generic [ref=f5e122]: A CLOSER LOOK / ICHIGO NEGRONI
        - generic [ref=f5e123]:
          - generic [ref=f5e124]: "01"
          - generic [ref=f5e125]:
            - heading "The finishing touch" [level=3] [ref=f5e126]
            - paragraph [ref=f5e127]: A yellow flower, a red garnish. The first details you see.
        - generic [ref=f5e128]:
          - generic [ref=f5e129]: "02"
          - generic [ref=f5e130]:
            - heading "A different clarity" [level=3] [ref=f5e131]
            - paragraph [ref=f5e132]: Strawberry and milk clarification shape MOGA’s interpretation.
        - generic [ref=f5e133]:
          - generic [ref=f5e134]: "03"
          - generic [ref=f5e135]:
            - heading "The foundation" [level=3] [ref=f5e136]
            - paragraph [ref=f5e137]: Explore the spirit, bitter and vermouth categories behind the drink.
        - link "Look inside the Ichigo Negroni" [ref=f5e138] [cursor=pointer]:
          - /url: /?drink=ichigo-negroni&expand=1
    - region [ref=f5e141]:
      - generic [ref=f5e142]:
        - generic [ref=f5e143]: BAR BON FUNK / MOGA / BAR SOMMA
        - heading "Same starting point. A different point of view." [level=2] [ref=f5e144]: Same starting point.A different point of view.
        - paragraph [ref=f5e145]: Put the three Negronis side by side.Rotate together. Open them up. Notice what changes.
        - link "Compare the three" [ref=f5e146] [cursor=pointer]:
          - /url: /?compare=bbf-negroni,ichigo-negroni,negroni-express&expand=1
  - contentinfo [ref=f5e154]:
    - link "SpiritAtlas." [ref=f5e155] [cursor=pointer]:
      - /url: /
    - paragraph [ref=f5e156]: Singapore’s cocktails. Inside out.
    - link "Back to Singapore" [ref=f5e157] [cursor=pointer]:
      - /url: /?bar=bar-bon-funk
```
