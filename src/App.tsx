...
export default function App() {
  ...
  return <>
    ...
    {route.page !== 'atlas' ? <footer className="site-footer"><a href="/">SpiritAtlas</a><span>Three interpretations. An invitation to look closer.</span><button className="text-button" onClick={openAtlas}>Return to the atlas <ArrowUpRight size={13} /></button></footer> : null}
  </>;
}
