...
The three specialty Negronis now share the original classic glass, ice and flowing-liquid animation with their own colors and garnishes. Their live scenes deconstruct, circulate while separated, and reassemble. See the [migration snapshot and validation](docs/specialty-animation-migration.md).
