"""CPU transport measurement of the isolated Somma true-contact scene.
...
parser.add_argument('--output', default='qa/evidence/blender/v012-contact-hero-optical-path-lengths.json')
