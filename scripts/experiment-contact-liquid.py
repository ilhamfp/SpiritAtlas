"""CPU construction and audit of a true-contact Somma optical boundary candidate.
...
out=P/'assets/blender/experiments/negroni-express-v012-true-contact-neutral-base.blend';scene.render.filepath=str(P/'qa/evidence/blender/negroni-express-hero-v012-true-contact-neutral-base.png')
...
out.with_suffix('.json').write_text(json.dumps(record,indent=2));(P/'qa/evidence/blender/v012-true-contact-cpu-construction.json').write_text(json.dumps(record,indent=2));print(json.dumps(record,indent=2))
